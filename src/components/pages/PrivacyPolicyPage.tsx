...
export const PrivacyPolicyPage: React.FC<Props> = ({}) => {
  return (
    <WrapperPageLayout>
      ...
      <p>
        At Smart Stock Alert, accessible from smartstockalert.io, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Smart Stock Alert and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Smart Stock Alert. This policy is not
      ...
      <p>
        Smart Stock Alert follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of Smart Stock Alert.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Smart Stock Alert, which are
      ...
      <p>
        Note that Smart Stock Alert has no access to or control over these
      ...
      <p>
        Smart Stock Alert's Privacy Policy does not apply to other advertisers
      ...
      <p>
        Smart Stock Alert does not knowingly collect any Personal Identifiable
